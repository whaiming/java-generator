...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    protected void addSelectNotDeleteByPrimaryKeyMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateSelectNotDeleteByPrimaryKey()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new SelectNotDeleteByPrimaryKeyMethodGenerator();
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
    ...
    protected void addSelectAllMethodGenerator(Interface interfaze){
    ...
    protected void addSelectNotDeleteAllMethodGenerator(Interface interfaze){
        if (introspectedTable.getRules().generateSelectNotDeleteAll()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new SelectNotDeleteAllMethodGenerator();
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
