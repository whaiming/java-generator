...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected void addSelectNotDeleteByPrimaryKeyElement(XmlElement parentElement) {

        if (introspectedTable.getRules().generateSelectNotDeleteByPrimaryKey()) {
            AbstractXmlElementGenerator elementGenerator = new SelectNotDeleteByPrimaryKeyElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
    ...
    protected void addSelectNotDeleteAllElement(XmlElement parentElement) {
        if (introspectedTable.getRules()
                .generateSelectNotDeleteAll()) {
            AbstractXmlElementGenerator elementGenerator = new SelectNotDeleteAllElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
